    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold text-orange-600">{data.summary.totalAtRisk}</div>
            <p className="text-xs text-gray-500 mt-1">
              5-6 consecutive leave days
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold text-red-600">{data.summary.totalSuspended}</div>
            <p className="text-xs text-gray-500 mt-1">
              7+ consecutive leave days
            </p>
          </CardContent>
        </Card>
      </div>
