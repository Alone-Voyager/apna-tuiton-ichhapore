  ...
  return (
    <div className="min-h-[100dvh] w-full bg-[#f8f9fc] relative overflow-hidden flex flex-col font-inter">
      ...
      <div className="flex-1 px-6 sm:px-10 pb-8 flex flex-col w-full max-w-md mx-auto relative z-10">
        ...
        <div className="flex flex-col items-center justify-center mt-8 pb-4 space-y-4">
          ...
          <p className="text-[14px] font-semibold text-slate-500">
            ...
            <Link href="/forgot-password" className="text-[#1a2b53] hover:text-slate-800 font-bold ml-1 tracking-tight underline">
              Reset it here
            </Link>
          </p>
        </div>
