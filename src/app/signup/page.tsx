...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-red-50 px-4 sm:px-6 lg:px-8 py-12">
      <div className="max-w-2xl w-full space-y-6">
        ...
        {/* Form Container */}
        <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 p-6 sm:p-8 lg:p-10">
