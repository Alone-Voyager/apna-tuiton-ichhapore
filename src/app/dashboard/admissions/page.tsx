  ...
  <Sidebar isOpen={sidebarOpen} onClose={() => setSidebarOpen(false)} />
        ...
        <div className="flex-1 lg:ml-64">
          <Header 
            ...
            subtitle="Manage student admissions and inquiries"
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                <div className="bg-white border border-slate-200 rounded-lg p-6">
                  <div className="flex items-center flex-col justify-center ">
                    ...
                    <div className='flex items-center justify-center flex-col'>
                      <p className="text-2xl font-bold text-slate-800">{loading ? '...' : studentStats.thisMonthAdmissions}</p>
                ...
                <div className="bg-white border border-slate-200 rounded-lg p-6">
                  <div className="flex items-center flex-col justify-between">
                    ...
                    <div className='flex items-center justify-center flex-col'>
                      <p className="text-2xl font-bold text-slate-800">{loading ? '...' : studentStats.totalStudents}</p>
                ...
                <div className="bg-white border border-slate-200 rounded-lg p-6">
                  <div className="flex items-center flex-col justify-between">
                    ...
                    <div className='flex items-center justify-center flex-col'>
                      <p className="text-2xl font-bold text-slate-800">{loading ? '...' : inquiries.length}</p>
                      <p className="text-sm text-slate-600">Inquiries (10 Days)</p>
                    </div>
