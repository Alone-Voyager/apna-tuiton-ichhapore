                  ...
                  <nav className="hidden xl:block space-y-2">
                    {tabs.map((tab) => (
                      <button
                        key={tab.id}
                        onClick={() => setActiveTab(tab.id)}
                        className={`w-full flex items-center space-x-3 p-3 rounded-xl text-left transition-all text-sm font-semibold ${activeTab === tab.id
              ...
              <div className="flex-1">
                ...
                {activeTab === 'general' && (
                  <div className="mt-6 lg:mt-8 flex flex-col sm:flex-row items-stretch sm:items-center justify-end space-y-3 sm:space-y-0 sm:space-x-4">
                    <Button
                      variant="outline"
                      className="sm:w-auto rounded-xl py-6"
                      onClick={() => {
                        fetchOrganization();
                      }}
                    >
                    ...
                    <Button
                      className="sm:w-auto rounded-xl py-6 bg-slate-900 hover:bg-black text-white"
                      onClick={handleSave}
