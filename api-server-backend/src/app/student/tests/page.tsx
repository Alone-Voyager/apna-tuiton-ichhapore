...
export default function StudentTestsPage() {
  ...
  useEffect(() => {
    fetch("/api/student/tests")
      .then((r) => {
        if (!r.ok) throw new Error("Failed to load test data");
        return r.json();
      })
      .then((d) => {
  ...
  return (
        <div className="w-full max-w-5xl mx-auto md:p-8 p-0 min-h-full">
            {/* Sticky Header SECTION */}
            <div className="sticky top-0 z-30 bg-[#f8fafc]/80 backdrop-blur-md border-b border-slate-200/50 p-5 space-y-4">
