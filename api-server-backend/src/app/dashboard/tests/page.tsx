              ...
              {selectedStudentIdx !== null && selectedTest && (
                <>
                  <div className="p-5 border-b border-slate-100 flex items-center gap-3 bg-slate-50/50">
                    <button onClick={() => setSelectedStudentIdx(null)} className="flex items-center gap-1.5 bg-white border border-slate-200 text-slate-600 hover:text-indigo-600 hover:border-indigo-200 hover:bg-indigo-50 px-3 py-2 rounded-xl text-sm font-bold shadow-sm transition-all active:scale-95 shrink-0">
                      <ChevronLeft className="w-4 h-4" />
                      Back
                    </button>
                    <div className="flex-1 min-w-0">
                      <h3 className="text-lg font-bold text-slate-800 leading-tight truncate">{detailedStudents[selectedStudentIdx].student.name}</h3>
